...
- 이러한 **문제인식**으로 출발한 Studycow는 다음과 같은 기획 배경을 가지고 있습니다.
...
- **통합화된 서비스의 부재**
    - 과거에도 다양한 온라인 스터디 서비스가 있었지만, 하나로 통합 관리하는 서비스는 없었습니다.

- studycow는 여러 서비스를 찾아다닐 필요 없이, 하나의 서비스 안에서 통합된 기능들을 제공합니다.
