...
public class PlannerChatRequest {
    ...
    public PlannerChatRequest(String model, String prompt) {
        this.model = model;
        ...
        this.messages.add(new Message("user",
                "당신에게 ResponseScoreDto 객체를 넘기겠습니다. 이 객체를 분석하여 조언 및 격려의 답변을 주세요.\n" +
                        ...
                        "2. targetScore: 해당 과목의 목표 점수입니다.\n" +
                        "3. targetGrade: 해당 과목의 목표 등급입니다.\n" +
                        ...
                        "5. 복습에 대해 이야기 할 때에는 특정 유형을 정확히 명시해야합니다. 예를 들어, '최근 수학1 유형을 자주 틀리고 있으니 복습하는 것이 좋겠소'와 같이 작성하세요.\n" +
                        "6. subName과 catName을 혼동하지 마세요. 두 값이 비슷하더라도 엄연히 다른 데이터입니다. subName은 과목, catName은 유형 입니다. \n" +
                        "7. scoreDetails 필드는 비어있을 수도 있습니다. 해당 필드가 많이 비어있는 경우, 오답유형을 입력하라는 조언을 해주세요. \n" +
                        "8. 사용자에게 답변을 할 때에는 필드 명을 절대로 얘기하지 마세요. scoreDetails 필드의 경우 '상세 내역'이라고 치환해야합니다. \n" +
                        "9. 성적이 점차 증가하는 추세를 보이고 목표에 도달했을 경우에는 칭찬을 해주세요.\n" +
                        "10. testDate와 testScore에 집중하여 최근 시험 성적에 대해 조언하세요. 과거의 시험 내역은 성적 동향 파악 및 오답 유형 파악용입니다.\n" +
                        "\n" +
