    ...
    public ScoreChatRequest(String model, String prompt) {
        ...
        this.messages.add(new Message("user",
            "당신에게 ResponseScoreDto 객체를 넘기겠습니다. 이 객체를 분석하여 조언 및 격려의 답변을 주세요.\n" +
                    ...
                    "8. testDate와 testScore에 집중하여 최근 시험 성적에 대해 조언하세요. 과거의 시험 내역은 성적 동향 파악 및 오답 유형 파악용입니다. \n" +
                    "9. diffScore가 null이 아닐 경우, 해당 수치에 맞도록 조언을 해주세요. 높을 경우 칭찬을, 낮을 경우에는 공부 조언을 해주세요." +
                    "\n" +
