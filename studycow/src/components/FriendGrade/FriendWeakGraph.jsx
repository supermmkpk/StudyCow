...
import "./styles/FriendWeakGraph.css"; // CSS 파일 import
...
const AnalyzeWeakGraph = ({ userId }) => {
  ...
  }, [userId, selectedSubject, fetchWeaknessPart]);
  ...
  // 컴포넌트 렌더링
  return (
    <div className="friendWeakGraph">
      <h3>취약점 분석 그래프</h3>
      <div className="friendChartContainer">
