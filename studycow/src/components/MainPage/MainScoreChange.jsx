...
const ScoreChange = ({ initialData, onClose, onScoreChange }) => {
  ...
  return (
    <div className="MainScoreChange-container">
      <div className="MainScoreChange-register">
        <h3>성적 수정/삭제</h3>
        <div className="MainScoreChange-form">
          <select
            className="MainScoreChange-select"
            name="subCode"
          ...
          <input
            type="date"
            className="MainScoreChange-input-date"
            name="testDate"
        ...
        <div className="MainScoreChange-form">
          <input
            type="number"
            className="MainScoreChange-input-number"
            name="testScore"
            min="0"
            max="100"
      ...
      <div className="MainScoreChange-mistake-register">
        <h3>오답 수정(선택사항)</h3>
        {scoreData.scoreDetails.map((detail, index) => (
          <div key={index} className="MainScoreChange-mistake-form">
            <select
              className="MainScoreChange-select"
            ...
            />
            <button
              className="MainScoreChange-remove-btn"
        ...
        <button className="MainScoreChange-add-btn" onClick={addWrongForm}>
          +
        </button>
      </div>

      <div className="MainScoreChange-button-group">
        <button className="MainScoreChange-update-btn" onClick={handleUpdate}>
          수정하기
        </button>
        <button className="MainScoreChange-delete-btn" onClick={handleDelete}>
          삭제하기
        </button>
        <button className="MainScoreChange-cancel-btn" onClick={onClose}>
          취소
        </button>
      </div>
    </div>
